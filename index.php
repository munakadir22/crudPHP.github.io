...
<body style="background-color:#ABB2B9"> <!-- background="img/bg/education.jpg"> -->
     <!-- Navbar -->
     <nav class="navbar navbar-expand-lg navbar-light bg-light text-uppercase">
          <div class="container">
               <a class="navbar-brand" href="index.php">Sistem Input Data Siswa</a>
     ...
     <div class="container">
          <div class="row my-2">
               <div class="col-md">
                    <h3 class="text-center fw-bold text-uppercase text-secondary data_siswa"></h3>
                    <hr>
               </div>
          </div>
          <div class="row my-2">
     ...
     <div class="container-fluid">
          <div class="row bg-light text-black text-center">
               <div class="col my-2" id="about">
                    <h4 class="fw-bold text-uppercase">About</h4>
                    <br><br><br>
                    <p>
                         © 2024 | Munawirah Kadir 
                    </p>
               </div>
          </div>
     </div>
